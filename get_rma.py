...
class RmatsResults(object):
    ...
    def __init__(self, dir):
        ...
        self.rmats_mxe = pd.read_table(os.path.join('data', dir, 'MXE.MATS.JunctionCountOnly.txt'), sep='\t')
        ...
        self.rmats_se = pd.read_table(os.path.join('data', dir, 'SE.MATS.JunctionCountOnly.txt'), sep='\t')
        ...
        self.rmats_ri = pd.read_table(os.path.join('data', dir, 'RI.MATS.JunctionCountOnly.txt'), sep='\t')
        ...
        self.rmats_a5ss = pd.read_table(os.path.join('data', dir, 'A5SS.MATS.JunctionCountOnly.txt'), sep='\t')
        ...
        self.rmats_a3ss = pd.read_table(os.path.join('data', dir, 'A3SS.MATS.JunctionCountOnly.txt'), sep='\t')
