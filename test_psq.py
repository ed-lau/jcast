...
class GenomeTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        genome = ReadGenome('testdata/Homo_sapiens.GRCh38.dna.chromosome.15.fa.gz')

        gtf = Annotation('testdata/Homo_sapiens.GRCh38.89.chromosome.15.gtf')
        gtf.read_gtf()

        rmats_results = RmatsResults('testdata/rmats/')
