...
class GenomeTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        genome = ReadGenome('jcast/tests/testdata/Homo_sapiens.GRCh38.dna.chromosome.15.fa.gz')

        gtf = Annotation('jcast/tests/testdata/Homo_sapiens.GRCh38.89.chromosome.15.gtf')
        gtf.read_gtf()

        rmats_results = RmatsResults('jcast/tests/testdata/rmats/')
